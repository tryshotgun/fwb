...
const redirectURI = `${process.env.FWB_URL}:${process.env.FWB_CLIENT_PORT}/${process.env.SPOTIFY_REDIRECT_URI}`; // (find in Spotify dashboard)
...
app.get('/login', (req, res) => {
  ...
  const scope =
    'user-read-private user-read-email user-top-read playlist-modify-public playlist-read-collaborative';
  res.redirect(
